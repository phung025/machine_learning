...
Finally, if you like this repository and want to use it as a guide to learn machine learning, then follow this arrow :arrow_upper_right: and fork the repo. I will be adding more materials and implementations in the future. Have fun! 
